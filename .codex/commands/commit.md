...
2. Check the **Topic-specific guidance** table in `AGENTS.md` and the topic docs under
   `.codex/docs/`: if the change touches an area a doc covers (cfapi, Immich API, thumbnails,
